...
const VaultPage = () => {
  ...
  return (
    <div className="min-h-screen bg-brand-cream text-brand-ink py-10 sm:py-16 lg:py-20 relative overflow-hidden flex flex-col justify-center select-none">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-10 sm:space-y-14 lg:space-y-16 relative z-10">
        
        {/* Header - Editorial & Minimalist */}
        <div className="space-y-3 sm:space-y-4 max-w-2xl border-b border-brand-tan-line pb-6 sm:pb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6">
          ...
          <div className="bg-white border border-stone-200 hover:border-brand-green hover:shadow-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 space-y-4 sm:space-y-6 transition-all duration-300 group">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <h3 className="font-serif-display text-xl sm:text-2xl text-brand-ink group-hover:text-brand-green transition-colors font-normal">
                Priority Window
              </h3>
        ...
        <div className="max-w-2xl bg-white border border-stone-200 rounded-2xl sm:rounded-3xl p-5 sm:p-8 lg:p-10 shadow-sm space-y-4 sm:space-y-6">
          <div className="space-y-1.5 sm:space-y-2">
            <h2 className="font-serif-display text-xl sm:text-3xl text-brand-green font-normal">
              Request access.
            </h2>
          ...
          {hasJoinedWaitlist ? (
            <div className="p-4 bg-brand-green/5 border border-brand-green/20 rounded-2xl text-brand-green flex items-start gap-3">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2.5 sm:gap-3">
              <input
                ...
                required
                className="flex-1 bg-brand-cream border border-stone-300 px-4 sm:px-5 py-3 text-xs text-brand-ink placeholder:text-brand-stone focus:outline-none focus:border-brand-green rounded-full transition-colors"
              />

              <button
                type="submit"
                className="px-7 py-3 bg-brand-green text-brand-cream font-bold text-xs uppercase tracking-widest hover:bg-brand-ink transition-colors rounded-full flex items-center justify-center gap-2 shadow-sm cursor-pointer"
              >

  ...
  return (
    <div className="min-h-screen bg-brand-cream text-brand-ink py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Header */}
        <div className="border-b border-brand-tan-line pb-8 mb-8 space-y-4">
          ...
          <h1 className="font-serif-display text-4xl sm:text-6xl font-normal text-brand-green capitalize">
            {currentGender}'s Footwear
          </h1>

          <p className="font-sans text-base text-brand-ink/80 max-w-xl">
          ...
          <div className="flex items-center gap-4 pt-4 text-xs font-mono font-bold uppercase">
            <Link
              to="/shop/men"
              className={`px-5 py-2.5 rounded-full border transition-colors ${
                currentGender === 'men'
                  ? 'bg-brand-green text-brand-tan border-brand-green'
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {items.map((product) => (
            <div
              key={product.id}
              className="bg-white rounded-3xl border border-brand-stone/30 p-6 flex flex-col justify-between hover:border-brand-tan transition-all duration-300 shadow-sm hover:shadow-xl group"
            >
              <div>
                ...
                <div className="my-6 aspect-[4/3] flex items-center justify-center bg-brand-cream/50 rounded-2xl p-4 group-hover:scale-105 transition-transform duration-500">
                  <img
                    src={product.image}
                    alt={product.name}
                ...
                <h3 className="font-serif-display font-normal text-2xl text-brand-green mb-1">
                  {product.name}
                </h3>
              ...
              <div className="pt-4 border-t border-brand-stone/20 flex items-center justify-between">
                <div>
                  {mode === 'phaseA' ? (
                ...
                {mode === 'phaseA' ? (
                  <Link
                    ...
                    className="px-5 py-2.5 bg-brand-green text-brand-tan font-bold text-xs uppercase tracking-wider hover:bg-brand-tan hover:text-brand-green transition-colors rounded-full flex items-center gap-1.5"
                  >
                  ...
                  <button
                    ...
                    className="px-5 py-2.5 bg-brand-tan text-brand-green font-bold text-xs uppercase tracking-wider hover:bg-brand-green hover:text-brand-tan transition-colors rounded-full flex items-center gap-1.5"
                  >

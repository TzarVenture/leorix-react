...
const NewHeroSection = () => {
  ...
  return (
    <section
      ref={stageRef}
      className="relative w-full min-h-[calc(94svh-88px)] h-auto md:h-auto md:min-h-[460px] lg:min-h-[500px] md:max-h-[580px] lg:max-h-[620px] bg-brand-green text-brand-cream overflow-hidden flex items-center border-b border-brand-tan/20 select-none cursor-default py-8 sm:py-12 md:py-8 lg:py-10"
      style={{
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-10 my-auto">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 items-center">
          ...
          <div className="md:col-span-6 relative flex items-center justify-center min-h-[220px] xs:min-h-[260px] sm:min-h-[300px] md:min-h-[350px]">
            
            {/* GSAP Interactive Shoe Stage */}
            <div className="relative w-full max-w-[290px] xs:max-w-[340px] sm:max-w-[440px] md:max-w-[500px] flex items-center justify-center">
              ...
              <div ref={levitationRef} className="relative w-full h-[225px] xs:h-[260px] sm:h-[300px] md:h-[340px] lg:h-[360px] flex items-center justify-center transform-gpu">
                ...
                {HERO_VARIANTS.map((variant, idx) => (
                  <img
                    ...
                    fetchpriority="high"
                    decoding="async"
                    className="absolute inset-0 m-auto w-full h-auto max-h-[215px] xs:max-h-[245px] sm:max-h-[285px] md:max-h-[330px] lg:max-h-[350px] object-contain drop-shadow-[0_16px_26px_rgba(0,0,0,0.60)] select-none pointer-events-none transform-gpu opacity-0"
                  />
                ))}
              </div>
